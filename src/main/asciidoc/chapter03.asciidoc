...
include::codes/hello-world-api/src/main/java/com/github/jinahya/verbose/hello/HelloWorld.java[lines=68..83]
----
...
include::codes/hello-world-api/src/main/java/com/github/jinahya/verbose/hello/HelloWorld.java[lines=120..130]
----
...
----
include::codes/hello-world-api/src/test/java/com/github/jinahya/verbose/hello/HelloWorldTest.java[lines=57..60]
----
<1> 아무런 동작도 하지 않는다.
...
데이터 제공자와 단위 시험 항목들이 준비되었다. 이제 `implemention()` 메서드를 구현하는 클래스들를 만들어보자.
