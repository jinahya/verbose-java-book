...
.BcUtils.java#nonBlockingWritable(Class<T>, T)
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/nio/channels/BcUtils.java[lines=46..52]
----
...
.BcUtils.java#nonBlockingWritable(Class<T>, T)
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/nio/channels/BcUtils.java[lines=53..66]
----
...
.BcUtils.java#nonBlockingWritable(Class<T>, T)
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/nio/channels/BcUtils.java[lines=67..69]
----
<1> 프록시 객체를 생성한다.
<2> 해당 형으로 변환하여 반환한다.
