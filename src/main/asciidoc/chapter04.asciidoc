...
이번주부터 당신은 고객사의 건물에 내부의 온도 센서를 전부 교체하는 프로젝트에 투입되었다. 당신에게 맞겨진 작업은 온도 센서를 설치하는 업체에서 제공한 API 를 기존 시스템에 맞게 적용하는 작업이다.
...
[source,java]
----
include::../../../src/main/java/com/github/jinahya/verbose/reflect/TemperatureSchedules.java[lines=29..37]
----
