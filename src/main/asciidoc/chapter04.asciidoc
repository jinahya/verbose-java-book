...
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/util/IoUtils1.java[lines=33..42]
----
<1> 크기(length)가 `0` 보다 큰 버퍼를 하나 생성하고
...
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/util/IoUtils1.java[lines=60..67]
----
...
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/util/MdUtils1.java[lines=30..39]
----
...
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/util/MdUtils1.java[lines=41..46]
----
...
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/util/MdUtils1.java[lines=58..63]
----
...
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/util/MdUtils2.java[lines=32..42]
----
...
----
include::codes/verbose-java-utils/src/main/java/com/github/jinahya/verbose/util/MdUtils2.java[lines=53..58]
----

=== Implementing an interface without implementing the interface

이번주부터 당신은 고객사의 건물에 내부의 온도 센서를 전부 교체하는 프로젝트에 투입되었다. 당신에게 맞겨진 작업은 온도 센서를 설치하는 업체에서 제공한 API 를 기존 시스템에 적용하는 작업이다.
...
우선 다음과 같이 {apidocs-javase}/java/lang/reflect/InvocationHandler.html[`java.lang.reflect.InvocationHandler`] 인터페이스를 구현하여 `FahrenheitThermoter#getTemperatureInFahrenheit()` 메서드 호출을 가로챈 후 `CelsiusThermometer` 객체를 이용하여 값을 반환도록 하자.
...
[source,java]
----
include::../../../src/main/java/com/github/jinahya/verbose/reflect/TemperatureSchedules.java[lines=42..50]
----
...
우선 http://docs.oracle.com/javase/8/docs/api/java/nio/channels/WritableByteChannel.html#write-java.nio.ByteBuffer-[`WritableByteChannel#write(ByteBuffer)`] 메서드를 선언한다.
...
----
<1> 호출된 메서드(`m`)가 미리 정의해 놓은 메서드(`method`, `WritableByteChannel#write(ByteBuffer)`)와 같으면
