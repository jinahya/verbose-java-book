...
[cols=">1,>1,>1,>1,<1",frame="top",options="header"]
.8-bit values
|====
|      |sign|exponent|mantissa|notes
|32-bit|`1` |`8`     |`23`    | bias = `127`
|64-bit|`1` |`11`    |`52`    | bias = `1023`
|====

----
32-bit: SEEEEEEE EMMMMMMM MMMMMMMM MMMMMMMM
64-bit: SEEEEEEE EEEEMMMM MMMMMMMM MMMMMMMM MMMMMMMM MMMMMMMM MMMMMMMM MMMMMMMM
----
