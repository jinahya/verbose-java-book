...
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexEncoder.java[lines=42..55]
----
...
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexEncoder.java[lines=64..72]
----
...
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexEncoder.java[lines=82..93]
----
...
`Base 16 Encoding` 으로 인코드된 문자들을 다사 숫자들로 변환하기 위한 인터페이스이다.
...
----
    // 입력 버퍼(encoded)에서 문자들을 디코드하고 결과를 출력 버퍼(decoded)에 담는다.
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexDecoder.java[lines=42..55]
----
...
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexDecoder.java[lines=64..72]
----
...
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexDecoder.java[lines=82..93]
----
...
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexOutputStream.java[lines=49..59]
----
...
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexInputStream.java[lines=54..57]
----
...
----
static void dangerous_copy(final File src, final File dst) throws IOException {
...
현재 위치를 표시(mark)한 후 `reset()` 메서드를 통해 다시 그 위치부터 읽을 수 있게 한다. `reset()` 메서드를 호출하기 전에 `readlimit` 보다 많은 바이트들이 소비되면 표시가 무효화(invalidate)된다. {apidocs-javase}/java/io/FilterInputStream.html#mark-int-[`FilterInputStream#mark(int)`] 메서드는 주어진 값을 `in` 객체의 `mark(int)` 메서드에 전달한다. `HexInputStream` 클래스는 다음과 같이 주어진 값의 두 배에 해당하는 값을 사용하도록 재정의되었다.

[source,java]
.HexInputStream.java#mark(int)
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexInputStream.java[lines=69..72]
----
...
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexInputStream.java[lines=83..102]
----
...
{apidocs-javase}/java/io/FilterInputStream.html#read-byte:A-int-int-[`FilterInputStream#read(byte[\],int,int)`] 메서드는 `in` 객체의 `read(byte[], int, int)` 메서드에 주어진 인자들을 전달한 후 그 결과값을 반환한다. `HexInputStream` 클래스는 다음과 같이 각각의 바이트들을 `read()` 메서드에 전달하도록 재정의 되었다.

[source,java]
.HexInputStream.java#read(byte[],int,int)
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexInputStream.java[lines=117..138]
----
...
{apidocs-javase}/java/io/FilterInputStream.html#skip-long-[`FilterInputStream#skip(long)`] 메서드는 `in.skip(n)` 값을 반환한다. `HexInputStream` 클래스는 아래와 같이 주어진 값보다 최대 `1` 만큼 작은 짝수값으로 시도하고 홀수만큼 건너뛰었으면 무조건 하나를 더 소비한다.

[source,java]
.HexInputStream.java#skip(long)
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/HexInputStream.java[lines=151..161]
----
<1> `n` 을 기준으로 (최대 1만큼 작은) 짝수만큼 시도한다.
<2> 실제로 건너뛴 개수가 홀수이면 하나를 더 읽어서 버린다.
<3> 실제로 `in` 객체에서 건너뛴 바이트 개수의 절반에 해당하는 값을 반환한다.
...
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/WritableHexChannel.java[lines=48..55]
----
...
----
include::codes/hex-codec-api/src/main/java/com/github/jinahya/verbose/hex/ReadableHexChannel.java[lines=54..72]
----
<1> `dst` 에 담을 수 있는 개수의 두 배만큼의 용량을 가지는 버퍼를 생성한다.
<2> `channel` 로부터 바이트드을 읽는다. 스트림의 끝(`end-of-stream`)에 도달했으면 `-1` 을 반환한다.
<3> 홀수의 개수만큼 읽혔다면 하나를 더 읽는다.
...
----
include::codes/hex-codec-lib/src/main/java/com/github/jinahya/verbose/hex/HexEncoderImpl.java[lines=20..36]
----
...
----
include::codes/hex-codec-lib/src/main/java/com/github/jinahya/verbose/hex/HexEncoderImpl.java[lines=38..47]
----
...
----
include::codes/hex-codec-lib/src/main/java/com/github/jinahya/verbose/hex/HexDecoderImpl.java[lines=20..43]
----
...
----
include::codes/hex-codec-lib/src/main/java/com/github/jinahya/verbose/hex/HexDecoderImpl.java[lines=45..53]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils1.java[lines=27..35]
----
<1> 버퍼를 하나 생성하고
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils1.java[lines=37..43]
----
...
[source,java]
.IoUtils2.java#copy1(ReadableByteBuffer, WritableByteBuffer)
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=34..48]
----
...
[source,java]
.IoUtils2.java#copy2(ReadableByteBuffer, WritableByteBuffer)
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=50..63]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=76..84]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=86..99]
----
...
.IoUtils2.java#copy2(Path, Path);
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/IoUtils2.java[lines=101..114]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils1.java[lines=29..39]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils1.java[lines=41..47]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils1.java[lines=59..64]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils2.java[lines=30..40]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/MdUtils2.java[lines=42..47]
----
...
.HexStreamTest.java#encodeDecodeFile()
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexStreamTest.java[lines=28..34]
----
...
.HexStreamTest.java#encodeDecodeFile()
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexStreamTest.java[lines=35..44]
----
...
.HexStreamTest.java#encodeDecodeFile()
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexStreamTest.java[lines=45..54]
----
...
.HexStreamTest.java#encodeDecodeFile()
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexStreamTest.java[lines=55..56]
----
...
.HexStreamTest.java#encodeDecodeFile()
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexStreamTest.java[lines=57..61]
----
...
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=38..41]
----
...
.HexChannelTest.java#encodeDecodePath(String)
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=54..60]
----
...
.HexChannelTest.java#encodeDecodePath(String)
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=61..70]
----
...
.HexChannelTest.java#encodeDecodePath(String)
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=71..81]
----
...
.HexChannelTest.java#encodeDecodePath(String)
----
include::codes/hex-codec-lib/src/test/java/com/github/jinahya/verbose/hex/HexChannelTest.java[lines=82..82]
----
...
----
include::codes/verbose-java-book/src/test/java/com/github/jinahya/verbose/hex/ClassFileTest.java[lines=29..44]
----
+
[NOTE]
====
...
----
include::codes/verbose-java-book/src/test/java/com/github/jinahya/verbose/hex/CharsetTest.java[lines=32..65]
----
...
hex-codec-api 모듈의 인터페이스들과 유사한 default 메서드들이 정의되어 있다.
...
include::codes/percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentEncoder.java[lines=39..50]
----
<1> `decoded` 버퍼의 `position` 값을 기록해 둔다.
<2> `decoded` 버퍼에 인코드할 바이트가 남아있은 동안 반복한다.
<3> `encodeOctet(int, ByteBuffer)` 메서드를 이용해 변환한다.
<4> `BufferOverflowException` 을 던지면 `decoded` 버퍼의 위치를 복귀시킨 후 반복 구문을 빠져나간다.
<5> 미리 기록해 둔 값과의 차이를 반환한다.
...
include::codes/percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentEncoder.java[lines=59..64]
----
<1> `decoded` 버퍼에 가용한 바이트 개수의 세 배에 해당하는 버퍼를 생성한다. (모든 바이트들이 `%XX` 형태로 변환된다고 가정한다.)
<2> `encode(ByteBuffer,ByteBuffer)` 메서드를 호출해 변한한다.
<3> `encoded` 버퍼를 뒤집어(flip) 읽을 수 있는 상태로 만든다.
...
----
include::codes/percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentEncoder.java[lines=75..82]
----
...
include::codes/percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentDecoder.java[lines=37..48]
----
<1> `decoded` 버퍼의 현재 위치(`position`) 값을 기록한다.
<2> `decoded` 버퍼에 디코드된 바이트들를 담을 수 있는 공간이 있는 동안 반복한다.
<3> `decode(ByteBuffer)` 에 `encoded` 버퍼를 전달하여 한 개 혹은 세 개의 문자를 한 개의 숫자로 디코드한 후 `decoded` 버퍼에 담는다.
<4> `BufferUnderflowException` 이 발생하면 순환 문을 빠져나간다.
<5> `decoded` 버퍼의 증가된 위치(`position`)와 이미 기록한 값(`previous`) 만큼의 차이를 반환한다.
...
include::codes/percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentDecoder.java[lines=57..62]
----
...
----
include::codes/percent-codec-api/src/main/java/com/github/jinahya/verbose/percent/PercentDecoder.java[lines=74..81]
----
<1> 문자열로부터 입력 배열을 생성한다.
...
include::codes/percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=40..43]

include::codes/percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=75..77]
}
----
...
----
include::codes/percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=50..52]
----
...
----
include::codes/percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentEncoderImpl.java[lines=54..73]
----
<1> 인코딩할 필요가 없는 숫자는 그대로 버퍼에 담는다.
<2> 인코딩이 필요한 문자는 한 개의 `"%"` 를 버퍼에 담고
<3> 게으르게(lazily) 적재된 `HexEncoder` 객체의 `encodeOctet(int, ByteBuffer)` 를 이용해 두개의 hex 문자를 버퍼이 담는다.
...
include::codes/percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentDecoderImpl.java[lines=38..41]

include::codes/percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentDecoderImpl.java[lines=72..74]
}
----
...
----
include::codes/percent-codec-lib/src/main/java/com/github/jinahya/verbose/percent/PercentDecoderImpl.java[lines=53..70]
----
<1> 첫 문자를 읽는다. `ByteBuffer#get(int)` 메서드들 사용해서 위치값을 증가시키지 않고 얻어온다.
<2> 첫 문자가 `%` 이면
<3> 게으르게(lazily) 초기회된 `hexDecoder` 객체의 `decodeOctet(ByteBuffer)` 메서드를 이용하여 디코드한 값을 반환한다.
<4> 디코딩이 필요치 않은 문자는 그대로 반환한다.
